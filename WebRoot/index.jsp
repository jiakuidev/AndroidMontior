		...
		<c:if test="${!empty deviceInfos}">
			...
			<c:forEach items="${deviceInfos }" var="deviceInfo"
				...
				<table class="table table-striped"
					style="width: 300px; float: left; text-align: center; font-size: 12px;">
					<tr>
					...
					<tr>
						<td colspan="2" rowspan="2"><a
							href="./device?serialNumber=${deviceInfo.serialNumber}"
							class="btn btn-primary btn-lg" role="button">进入调试</a></td>
					</tr>
				</table>
